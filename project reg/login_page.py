...
class login_page:
    def __init__(self, root):
        ...
        label1 = Label(self.frame1, text= "WEL", font=("times new roman", 40, "bold"), bg="pink", fg="red").place(x=65,y=300)
        label2 = Label(self.frame1, text= "COME", font=("times new roman", 40, "bold"), bg="pink", fg="RoyalBlue1").place(x=200,y=300)
        label3 = Label(self.frame1, text= "Register Form", font=("times new roman", 15, "bold"), bg="pink", fg="brown4").place(x=100,y=360)
        ...
        self.frame3 = Frame(self.frame2, bg="#253644")
    ...
    def login_func(self):
        if self.email_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                connection=pymysql.connect(host="localhost", user="user1", password="prathamesh@37", database="student_database")
